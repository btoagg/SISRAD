package mx.edu.utez.sisrad.sisrad.Model;

import mx.edu.utez.sisrad.sisrad.Utils.MysqlConector;
...
public class DaoUsuario implements DaoRepository {
    ...
    public List findAll() {
        ...
        try {
            PreparedStatement stmt = conexion.prepareStatement("select * from Registro");
